...
const ProductModal = ({ product, onClose, onCreditRequest }) => {
  ...
  const redirectToProductDetail = () => {
    // Lógica para redirigir a la página de detalle del producto
    console.log("Redirigiendo a la página de detalle del producto");
    // Puedes realizar alguna lógica de redirección aquí, por ejemplo:
  ...
  return (
    <Dialog open={true} onClose={onClose} maxWidth="md">
      ...
      <Box sx={{ display: 'flex', justifyContent: 'center', marginBottom: '20px' }}>
        <Button marginTop="20px" variant="contained" color="primary" onClick={redirectToProductDetail}>
          Credito
        </Button>
      </Box>
